...
To see the commands you can use , please type !help 
...
Pour voir les commandes que vous pouvez utiliser, veuillez saisir !help 
...
.تمت برمجتي من قبل مؤسسة أفريكا لمساعدتكم على إيجاد إجابات  لأسئلتك في مجالات علم الفلك والمعلوماتية الحيوية وعلوم البيانات.
 للمزيد من المعلومات يرجى إدخال !help 
```  '''
...
async def on_ready():
    ...
    chanel = client1.get_channel(809014144941817876)
    ...
    if cmd != '':
        ...
        def is_command (msg): # Checking if the message is a command call
            ...
            if (key=='help'): 
                ...
                if(key == 'score' or key == 'improvement'):
